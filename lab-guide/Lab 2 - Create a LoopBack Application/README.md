...
**ThinkIBM** は、歴史的価値がある希少な IBM 機器を取り扱う販売会社です。 **ThinkIBM** は 複数の API を利用して、製品アイテム・データベースへのアクセスを簡素化したいと考えていました。また、このアプリケーションに購入者がレビューを残す機能を持たせることも必要です。このラボの受講者の目的はアプリケーション開発者として、この製品在庫へアクセスするためのアプリケーションを作成することです。
