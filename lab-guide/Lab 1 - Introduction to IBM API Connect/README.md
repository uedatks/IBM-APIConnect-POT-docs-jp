...
2.	API Connect Developer ツールキットのコマンドライン・インターフェースを使用して最初のアプリケーションを作成し、確認します。ターミナルのコマンドラインに以下を入力します:
...
|common/models|すべてのモデルに関する JSON ファイル、と JavaScript ファイルが格納されるサブディレクトリー。ここでいうモデルとはデータ・モデルを指す|
